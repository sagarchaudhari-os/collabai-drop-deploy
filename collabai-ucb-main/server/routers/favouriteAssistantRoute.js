import { addFavouriteAssistant, getAllFavouriteAssistant, getSingleFavouriteAssistant, updateSingleFavouriteAssistant, deleteSingleFavouriteAssistant, getSingleUsersFavAssistWithDetails, getSingleUsersFavAssistWithoutSkip } from '../controllers/favoriteAssistantController.js';
...
favoriteRouter.get('/:id/all-favorite-assistant', authenticateUser, getSingleUsersFavAssistWithoutSkip);
