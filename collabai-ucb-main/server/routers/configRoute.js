...
configRouter.post('/encrypt', encryptConfigs);
 configRouter.post('/decrypt', decryptConfigs);
 configRouter.get('/migrate', migrateConfigs);
 configRouter.get('/reverse-migration', reverseMigration);
